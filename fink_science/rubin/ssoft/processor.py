...
COLUMNS = {
    "designation": {
        "type": "str",
        "description": "Designation (name or number) of the object from MPC archive as given by Rubin",
    },
    "sso_name": {
        "type": "str",
    ...
    **{
        "H_{}".format(f): {
            "type": "double",
            "description": "Absolute magnitude for the Rubin filter band {}".format(f),
        }
        for f in FILTERS
    },
    **{
        "err_H_{}".format(f): {
            "type": "double",
            "description": "Uncertainty on the absolute magnitude for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
    ...
    **{
        "min_phase_{}".format(f): {
            "type": "double",
            "description": "Minimum phase angle of the observations used to compute the phase function for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
    ...
    **{
        "max_phase_{}".format(f): {
            "type": "double",
            "description": "Maximum phase angle of the observations used to compute the phase function for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
    ...
    **{
        "rms_{}".format(f): {
            "type": "double",
            "description": "RMS of the fit for the Rubin filter band {}".format(f),
        }
        for f in FILTERS
    },
    **{
        "median_error_phot_{}".format(f): {
            "type": "double",
            "description": "Median of the 1-sigma uncertainty on the measurements for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
    ...
    **{
        "n_obs_{}".format(f): {
            "type": "double",
            "description": "Number of observations for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
    ...
    **{
        "n_days_{}".format(f): {
            "type": "double",
            "description": "Number of days between the first and the last observations in Fink for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
...
COLUMNS_HG = {
    **{
        "G_{}".format(f): {
            "type": "double",
            "description": "G phase parameter for the Rubin filter band {}".format(f),
        }
        for f in FILTERS
    },
    **{
        "err_G_{}".format(f): {
            "type": "double",
            "description": "Uncertainty on the G phase parameter for the Rubin filter band {}".format(
                f
            ),
        }
        for f in FILTERS
