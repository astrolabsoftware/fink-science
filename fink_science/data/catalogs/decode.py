...
"""Decode and format GCVS and VSX catalogs.

Download GCVS catalog (http://sai.msu.su/gcvs/gcvs/) as txt file, and
VSX from Vizier as tsv file, and simply run `python decode_catalogs.py`
"""
...
for line in buf.readlines():
    arr.append([line[i[0] : i[1]].decode("utf8") for i in bytes_step])  # noqa: PERF401
...
vsx_tmp = pd.read_csv(
    ...
    sep=";",
    header=None,
    names=["OID", "Name", "VType", "Period", "RAJ2000", "DEJ2000"],
)
