...
args = [
    ...
    F.lit(30), F.lit(2), F.lit(2), F.lit(30), F.lit(True)
]
...
df_filt = df.filter((df["roid.flag"] == 4) | (df["roid.flag"] == 5)).select(df.columns + ["roid.flag", "roid.ffdistnr", "roid.estimator_id"])
print()
print()
